...
ListView {
    ...
    MessageDialog {
        ...
        text: "Soll das ausgewählte Rezept wirklich gelöscht werden?"
        standardButtons: StandardButton.Yes | StandardButton.Abort
        onYes: model.removeRow(currentIndex)
        onRejected: close()
    }
    ...
    Window {
        ...
        Button {
            ...
            anchors.horizontalCenterOffset: -((yesButton.width/2) + 40 )
            anchors.bottom: parent.bottom
            anchors.bottomMargin: yesButton.height
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                TextField {id: tfAmount; selectByMouse: true; text: "20.0"; font.pointSize: 14; Layout.leftMargin: tDate.leftPadding}
            }
            GridLayout {
                Layout.alignment: Qt.AlignTop
                Layout.topMargin: 10
    ...
    Window {
        ...
        Button {
            ...
            font.pointSize: 15
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.horizontalCenterOffset: -((yesButton2.width/2) + 40 )
            anchors.bottom: parent.bottom
            anchors.bottomMargin: yesButton2.height
            width: parent.width * 1/5
            height: parent.height * 1/10
            onClicked: {
        ...
        Button {
            ...
            anchors.bottom: yesButton2.bottom
            anchors.leftMargin: 40
            width: parent.width * 1/5
            height: yesButton2.height
    ...
    Window {
        ...
        Button {
            ...
            font.pointSize: 15
            anchors.horizontalCenter: parent.horizontalCenter
            anchors.horizontalCenterOffset: -((yesButton3.width/2) + 40 )
            anchors.bottom: parent.bottom
            anchors.bottomMargin: yesButton3.height
            width: parent.width * 1/5
            height: parent.height * 1/10
            onClicked: {
                RecipeGraph.setData(tfNumber3.text, tfName3.text, tfDate3.text, tfAmount3.text)
                ...
                TempData.setupTimers(RecipeGraph.getTotalX() + 10)
                infoRecipeWindow.close()
                loadback.source = "main.qml"
            }
        }
        ...
        Button {
            ...
            anchors.bottom: yesButton3.bottom
            anchors.leftMargin: 40
            width: parent.width * 1/5
            height: yesButton3.height
    ...
    header: RowLayout {
        ...
        Rectangle {
            ...
            Text {
                ...
                font.pointSize: 16
                font.bold: true
                leftPadding: recipeView.width * 5/12
                anchors.verticalCenter: parent.verticalCenter
            }
            Text {
                text: "Aktionen"
                font.pointSize: 16
                font.bold: true
                leftPadding: recipeView.width * 8/12
                anchors.verticalCenter: parent.verticalCenter
            }
            Button {
                width: 70
    ...
    delegate: Column {
        ...
        Rectangle {
            ...
            color: Material.color(Material.Grey, 3)
            border.color: "black"
            MouseArea {
